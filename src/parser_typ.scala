...
//   lazy val pFunDef: PackratParser[(String, FunType)] =
...
//   lazy val pCasesDef: PackratParser[(String, (PathType, FunType))] =
//     kwCases ~> pFunctionName ~ pMatchType ~ (":" ~> optBetween("(", ")", pFunType)) ~ pMarker ~ pExp ^^ {
//       case n~mt~ft~_~_ => n -> (mt, ft)
//     }

//   val cases_suffix = "_cases"
//   type FunHeader = (String, FunType)
//   type CasesHeader = (String, (PathType, FunType))
//   type ExtendedDef = (Option[FunHeader], CasesHeader)
...
//       val funHeader = marker match {
//         case Eq => Some((name, foldedType))
//         case PlusEq => None
//       }
//       val casesHeader = (name_cases, (matchType, t))
//       success(name -> (funHeader, casesHeader))
//     }
//   }
...
//       fams => 
//         DefinitionLinkage(
//           Sp(Prog), Prog, None, Map(), Map(), Map(), Map(),
//           fams.toMap
//         )
//     }
